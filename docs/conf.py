...
latex_documents = [
    (master_doc, 'dynaconf.tex', 'dynaconf Documentation',
     'Bruno Rocha', 'manual'),
]
...
man_pages = [
    (master_doc, 'dynaconf', 'dynaconf Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dynaconf', 'dynaconf Documentation',
     author, 'dynaconf', 'The dynamic configurator for Python.',
     'Miscellaneous'),
]
