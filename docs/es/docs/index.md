...
<div style="border-color: yellow;border: 0.05rem solid #yellow;border-radius: 0.2rem;
...
<p style="background-color:rgba(255,145,0,.1)> <span style="color:yellow">&#9888;</span> Warning </p>
